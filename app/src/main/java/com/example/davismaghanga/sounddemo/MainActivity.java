package com.example.davismaghanga.sounddemo;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            try{
            //BASICALLY WE ARE LOADING THE AUDIO FILES INTO MEMORY
            //create objects for the two required classes
                AssetManager assetManager = this.getAssets();// used to read a file
                AssetFileDescriptor descriptor;// this is for identifying a particular file (identification)
